...
function renderHome(){
  ...
  let html=`<section class="hero">
    ...
    <p>集 <b>语法精讲 · 单词背诵 · 入学测试</b> 于一体的离线英语自学工具：系统讲解 词法 · 时态语态 · 复合句与非谓语，配套练习、抽认卡与闯关挑战；内置 考研 / 雅思 / 阅读近义词辨析 三大词库与入学测试卷。学习进度、笔记与成绩自动保存在本机，随时回顾。</p>
...
const TUT=[
  {i:"👋",t:"欢迎使用",b:"欢迎来到 <b>《英语语法速通宝典》</b>！集 <b>语法精讲 · 单词背诵 · 入学测试</b> 于一体的离线英语自学工具，所有进度与笔记都<b>保存在本机</b>，无需登录。<br><br>💡 建议把链接<b>复制到浏览器</b>打开使用，<b>不要直接在微信里打开</b>（微信内部分功能与 PDF 导出会受限）。<br><br>下面用 1 分钟带你认识全部功能 👇"},
